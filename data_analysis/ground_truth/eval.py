...
plt.subplot(2,2,1)
plt.hist(kron_mse_task1,color="C3",alpha=0.5)
plt.xlim((0,1))
plt.subplot(2,2,2)
plt.hist(kron_mse_task2,color="C3",alpha=0.5)
plt.xlim((0,1))
plt.subplot(2,2,3)
plt.hist(multi_mse_task1,color="C0",alpha=0.5)
plt.xlim((0,1))
plt.subplot(2,2,4)
plt.hist(multi_mse_task2,color="C0",alpha=0.5)
plt.xlim((0,1))
plt.show()
