...
np.savetxt("ex5_interval_mse.csv",mse,delimiter=",",fmt="%s")

plt.subplot(3,2,1)
plt.fill_between(eval_x.detach().numpy(),
                 lower.detach().numpy()[:,1],
                 upper.detach().numpy()[:,1],color="C0",alpha=0.3)
...
plt.fill_between(eval_x.detach().numpy(),
                 ...
                 upper.detach().numpy()[:,0],color="C1",alpha=0.3)
...
plt.fill_between(eval_x.detach().numpy(),
                 ...
                 kronupper.detach().numpy()[:,1],color="C0",alpha=0.3)
plt.scatter(train_x.detach().numpy(),train_y.detach().numpy()[:,1],color="C0")
plt.plot(eval_x.detach().numpy(),ex5[:,2],color="black")
...
plt.fill_between(eval_x.detach().numpy(),
                 ...
                 kronupper.detach().numpy()[:,0],color="C1",alpha=0.3)
plt.scatter(train_x.detach().numpy(),train_y.detach().numpy()[:,0],color="C1")
plt.plot(eval_x.detach().numpy(),ex5[:,1],color="black")
